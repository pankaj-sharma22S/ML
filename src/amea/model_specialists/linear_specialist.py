"""Linear and Logistic Model Specialist Agent."""
...
class LinearSpecialistAgent(ModelSpecialistBase):
    """Specialist managing convex linear and regularized logistic models."""
    ...
    def capabilities(self) -> ModelCapability:
        return ModelCapability(
            ...
            strengths=["Convex optimization", "Extreme sample efficiency", "Interpretable coefficients", "Sub-millisecond inference"],
            limitations=["Limited non-linear representation without manual feature expansion"],
    ...
    def validate_experiment(
        ...
        if task_spec.task_type not in caps.supported_task_types:
            return SpecialistValidationResult(
                is_compatible=False,
                status="INCOMPATIBLE",
                rejection_reason=f"LinearSpecialist does not support task type '{task_spec.task_type.value}'.",
    ...
    def prepare_execution(
        ...
        model_cls = "LogisticRegression" if is_classification else "Ridge"
